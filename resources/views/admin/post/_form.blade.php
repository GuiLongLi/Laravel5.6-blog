<div class="row">
            ...
            <div class="col-md-10">
                <div class="row">
                    ...
                    <div class="col-md-4 text-right">
                        <img src="{{ page_image($page_image) }}" class="img img_responsive" id="page-image-preview" style="max-height:40px;" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-4">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <textarea name="meta_description" id="meta_description"  rows="6" class="form-control">{{ $meta_description }}</textarea>
            </div>
        </div>
    </div>
</div>